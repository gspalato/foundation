...
<h3 align="center"><b>Foundation</b></h3>
  ...
  <p align="center">
    A back-end monorepo for deployment on my server.
    <br />
...
Ether is my portfolio website's back-end.
Currently it fetches my projects from GitHub that have a `.project/metadata.yml` and updates the database every 5 minutes.

### Identity

A private microservice that handles authentication and JWT tokens. Other services might rely on Identity to allow access to certain data.

### Proxy

A NGINX instance acting as reverse proxy for the APIs.
